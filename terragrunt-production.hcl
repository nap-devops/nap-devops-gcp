...
inputs = {
  ...
  top_level_domain2 = "admx.napbiotec.io"
  additional_domain_names = ["www.napbiotec.io", "napbiotec.io", "www.napbiotec.com", "napbiotec.com"]
  additional_domain_names2 = ["www.admx.napbiotec.io", "admx.napbiotec.io"]
